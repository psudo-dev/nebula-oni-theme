...
const updateMessage =
	`${themeTextName} Theme has been updated! Just a minor color correction for TYPE. Help support Nebula Oni Color Theme by leaving a review on the VSCode Market Place and help spread the word! Thanks!`
