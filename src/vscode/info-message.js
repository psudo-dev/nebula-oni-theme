...
const updateMessage = `${themeTextName} v2.1.0 is here! Some colors have been changed and a minor update to the minimap. Help support Nebula Oni by reviewing it on the Market Place and help spread the word! Thanks!`;
