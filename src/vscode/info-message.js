...
const updateMessage = `${themeTextName} v2.2.4 is here! For more info, check the CHANGELOG page. I made a monospaced font with ligatures to pair up with ${themeTextName}! Search for "psudoFont Liga Mono", go check it out! Help support Nebula Oni Theme by reviewing it on the Market Place and Github! Thanks!`;
